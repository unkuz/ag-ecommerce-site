          ...
          <div className="col-md-4">
            <div className="footer_right">
              ...
              <div className="certification">
                <img src="images/rx1.png" />
                <img className="img_center" src="images/rx3.png" />
                <img src="images/rx2.png" />
              </div>
              <h4 className="footer_title">
                Tải ứng dụng trên
                <span />
              ...
              <div className="certification">
                <a>
                  <img src="images/google.jpg" style={{ marginRight: 15 }} />
                </a>
                <a>
        ...
        <div className="payment_method">
          ...
          <div className="payment_box">
            ...
            <ul>
              <li>
                <a>
                  <img src="images/n1.png" style={{ width: 125, padding: 6 }} />
                </a>
              </li>
              <li>
                <a>
                  <img src="images/n2.png" style={{ width: 125, padding: 6 }} />
                </a>
              </li>
              <li>
                <a>
                  <img src="images/n3.png" style={{ width: 125, padding: 6 }} />
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="shipping_method">
          ...
          <div className="shipping_box">
            <ul>
              ...
              <li>
                <a>
                  <img src="images/vt.jpg" style={{ padding: 3 }} />
                </a>
              </li>
              <li>
                <a>
