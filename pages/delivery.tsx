                ...
                <ul className="accordion_menuBar">
                  ...
                  <li>
                    ...
                    <ul className="menuBarList" style={{ display: "block" }}>
                      <li>
                        <a href="wait_for_pay.html">Chờ lấy hàng</a>
                      </li>
                      <li>
                        <a href="delivery.html" className="active_info">
                          Đang giao
                        </a>
                      </li>
                      <li>
            ...
            <div className="col-md-9 col-small clear_pdleft">
              <div className="right_bgCt bg_accRight">
                <div className="group_elm">
                  ...
                  <h4 className="tp">Đang giao hàng</h4>
                </div>
                <div className="info_order_1">
                  ...
                  <div className="prices__">
                    {/*  <p>Phí vận chuyển (chuyển phát nhanh): <span><strong>40.000đ</strong></span></p> */}
                    ...
                    >
                      ...
                      <time style={{ color: "#999", marginLeft: 5 }}>
                        17:18 10/12/2019
                      </time>{" "}
                      <br />
                      <span style={{ color: "#999" }}>
                        Nhận sản phẩm và thanh toán muộn nhất vào 15/12/2019.
                        Vui lòng chuẩn bị số tiền tương ứng để nhận bưu phẩm.
                      </span>
                    </p>
                  </div>
                </div>
