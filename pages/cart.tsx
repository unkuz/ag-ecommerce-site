                  ...
                  <div className="product_cart_1">
                    ...
                    <div className="proName_cart">
                      ...
                      <div className="prices">
                        <span className="price1_">10.999.000đ</span>
                        <span className="price2_">12.999.000đ</span>
                      </div>
                      <div className="color">
                        <span>Đỏ</span>
                      </div>
                ...
                <div className="cart_orderinfo">
                  ...
                  <div className="bg_">
                    ...
                    <div className="total_price">
                      <p>
                        Tổng giá sản phẩm: <span>32,997,000đ</span>
                      </p>
                      <p>
                        Phí vận chuyển(tạm tính): <span>123.000đ</span>
                      </p>
                    </div>
                    <div className="total_price_2">
                      <p>
                        Tổng tiền <span>Đã bao gồm VAT</span>
                      </p>
                      <span className="price_End">33,037,000đ</span>
                    </div>
                    <div className="cart_confirm_btn">
                      <a href="checkout.html">Xác nhận giỏ hàng</a>
                    </div>
                  </div>
                </div>
              </div>
